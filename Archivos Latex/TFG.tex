...
\renewcommand{\umlfillcolor}{purple!20}
...
\definecolor{colorCalcPC}{HTML}{4A90E2}   % Blue
\definecolor{colorSendPC}{HTML}{F5A623}   % Orange
\definecolor{colorCalcPSoC}{HTML}{7ED321} % Green
\definecolor{colorSendPSoC}{HTML}{D0021B} % Red
