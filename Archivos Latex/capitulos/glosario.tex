...
\newacronym{kat}{KAT}{Known Answer Test o Test de Respuesta Conocida}
\newacronym{rng}{RNG}{Random Number Generator o Generador de Números Aleatorios}
\newacronym{trng}{TRNG}{True Random Number Generator o Generador de Números Aleatorios Verdadero}
\newacronym{fifo}{FIFO}{First In First Out}
\newacronym{hmac}{HMAC}{Código de Autenticación de Mensaje Basado en Hash}
\newacronym{aes}{AES}{Advanced Encription Standart}
\newacronym{qkd}{QKD}{Distribución Cuántica de Claves}
\newacronym{qft}{QFT}{Transformada Cuántica de Fourier}
\newacronym{gake}{GAKE}{Group Authenticated Key Exchange}
