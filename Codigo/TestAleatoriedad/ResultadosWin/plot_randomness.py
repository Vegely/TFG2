...
# --- CONFIGURATION ---
FILE_PATH = "clean_test.bin"   # Your filename
SAMPLES_TO_READ = 100000000      # 1 MB is sufficient for visualization
OUTPUT_FORMAT = "svg"          # 'svg' or 'pdf' are best for vector graphics
