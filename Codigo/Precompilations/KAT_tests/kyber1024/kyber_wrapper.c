...
static kyber_security_level_t current_security_level = KYBER_SECURITY_1024;
...
// KAT-specific functions that expose the randombytes initialization
void kyber_randombytes_init(const unsigned char *entropy_input,
